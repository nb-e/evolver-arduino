...
void read_MuxShield() {
  ...
  SerialUSB.println("_____________________________");
  time1 = millis();
  SerialUSB.println("Starting read_Muxshield");
  ...
  SerialUSB.print("readMux took: ");
  SerialUSB.println(rtime);
  SerialUSB.print("Serial took: ");
  SerialUSB.println(stime);
  
  SerialUSB.print("Done read_Muxshield: ");
